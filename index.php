...
<div class="container">
    <div class="row text-center">
        ...
        <!-- Team item -->
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="docs/images/Romero_Loli_Harby_0201814025.jpg"  width="150" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
